...
class Oss
{
    ...
    {
        empty($this->ak) && $this->ak = ap_conf('oss_ak');
        empty($this->sk) &&  $this->sk = ap_conf('oss_sk');
        empty($this->bucket) &&  $this->bucket = ap_conf('oss_bucket');
        empty($this->endpoint) &&  $this->endpoint = ap_conf('oss_endpoint');
    }
